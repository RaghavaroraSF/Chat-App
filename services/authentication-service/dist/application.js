...
exports.ChatAppApplication = void 0;
...
class ChatAppApplication extends (0, boot_1.BootMixin)((0, service_proxy_1.ServiceMixin)((0, repository_1.RepositoryMixin)(rest_1.RestApplication))) {
    constructor(options = {}) {
        var _a, _b, _c, _d, _e;
        const port = 3000;
        dotenv.config();
...
exports.ChatAppApplication = ChatAppApplication;
